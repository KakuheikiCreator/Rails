...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      assert(create_action.reg_cookie.system_id == system_id, "CASE:2-1-1-3")
      assert(create_action.reg_cookie.cookie == cookie, "CASE:2-1-1-4")
      assert(create_action.reg_cookie.remarks == remarks, "CASE:2-1-1-5")
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      assert(create_action.reg_cookie.system_id == system_id.to_i, "CASE:2-1-2-3")
      assert(create_action.reg_cookie.cookie == cookie, "CASE:2-1-2-4")
      assert(create_action.reg_cookie.remarks == remarks, "CASE:2-1-2-5")
      assert(create_action.sort_item == 'cookie', "CASE:2-1-2-6")
...
#      print_log('system_id:' + reg_cookie.system_id.to_s)
      assert(reg_cookie.system_id == system_id, "CASE:2-1-3-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-3-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-3-5")
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      reg_cookie = create_action.reg_cookie
#      print_log('system_id:' + reg_cookie.system_id.to_s)
      assert(reg_cookie.system_id == 0, "CASE:2-1-4-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-4-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-4-5")
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      reg_cookie = create_action.reg_cookie
      assert(reg_cookie.system_id == system_id, "CASE:2-1-5-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-5-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-5-5")
...
#      print_log('cookie:' + create_action.error_msg_hash[:cookie].to_s)
      assert(create_action.error_msg_hash[:cookie] == 'クッキー を入力してください。', "CASE:2-1-5-10")
    rescue => ex
      error_log("Exception:" + ex.class.name)
      error_log("Message  :" + ex.message)
      error_log("Backtrace:" + ex.backtrace.join("\n"))
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      reg_cookie = create_action.reg_cookie
      assert(reg_cookie.system_id == system_id, "CASE:2-1-6-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-6-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-6-5")
...
#      print_log('cookie:' + create_action.error_msg_hash[:cookie].to_s)
      assert(create_action.error_msg_hash[:cookie] == 'クッキー は1024文字以内で入力してください。', "CASE:2-1-6-10")
    rescue => ex
      error_log("Exception:" + ex.class.name)
      error_log("Message  :" + ex.message)
      error_log("Backtrace:" + ex.backtrace.join("\n"))
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      reg_cookie = create_action.reg_cookie
      assert(reg_cookie.system_id == system_id, "CASE:2-1-7-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-7-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-7-5")
...
#      print_log('cookie:' + create_action.error_msg_hash[:cookie].to_s)
      assert(create_action.error_msg_hash[:cookie] == 'クッキー は不正な値です。', "CASE:2-1-7-10")
    rescue => ex
      error_log("Exception:" + ex.class.name)
      error_log("Message  :" + ex.message)
      error_log("Backtrace:" + ex.backtrace.join("\n"))
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      reg_cookie = create_action.reg_cookie
      assert(reg_cookie.system_id == system_id, "CASE:2-1-8-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-8-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-8-5")
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      reg_cookie = create_action.reg_cookie
      assert(reg_cookie.system_id == system_id, "CASE:2-1-9-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-9-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-9-5")
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      reg_cookie = create_action.reg_cookie
      assert(reg_cookie.system_id == system_id, "CASE:2-1-10-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-10-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-10-5")
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      reg_cookie = create_action.reg_cookie
      assert(reg_cookie.system_id == system_id, "CASE:2-1-11-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-11-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-11-5")
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      reg_cookie = create_action.reg_cookie
      assert(reg_cookie.system_id == system_id, "CASE:2-1-12-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-12-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-12-5")
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      reg_cookie = create_action.reg_cookie
      assert(reg_cookie.system_id == system_id, "CASE:2-1-13-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-13-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-13-5")
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      reg_cookie = create_action.reg_cookie
      assert(reg_cookie.system_id == system_id, "CASE:2-1-14-3")
      assert(reg_cookie.cookie == cookie, "CASE:2-1-14-4")
      assert(reg_cookie.remarks == remarks, "CASE:2-1-14-5")
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      assert(create_action.reg_cookie.system_id == system_id, "CASE:2-2-1-3")
      assert(create_action.reg_cookie.cookie == cookie, "CASE:2-2-1-4")
      assert(create_action.reg_cookie.remarks == remarks, "CASE:2-2-1-5")
...
#      print_log('error hash:' + create_action.error_msg_hash.to_s)
      ...
      # 保存データ確認
      create_data = RegulationCookie.duplicate(create_action.reg_cookie)
      ...
      assert(reg_cookie_list.size == 5, "CASE:2-2-1-14")
      # キャッシュデータ確認
...
#      print_log('error msg:' + create_action.error_msg_hash.to_s)
      ...
      # アクセサ
      assert(create_action.reg_cookie.system_id == system_id, "CASE:2-2-2-3")
      assert(create_action.reg_cookie.cookie == cookie, "CASE:2-2-2-4")
      assert(create_action.reg_cookie.remarks == remarks, "CASE:2-2-2-5")
...
#      print_log('disp_counts:' + create_action.error_msg_hash[:disp_counts].to_s)
      ...
      # 検索結果確認
      assert(create_action.reg_cookie_list.size == 5, "CASE:2-2-2-12")
    rescue => ex
      error_log("Exception:" + ex.class.name)
      error_log("Message  :" + ex.message)
      error_log("Backtrace:" + ex.backtrace.join("\n"))
