...
$(document).ready(function() {
	...
	$("#input_form").validate({
		...
		rules: {
			"regulation_referrer[system_id]": {server_err: "#sverr_system_id"},
			"regulation_referrer[referrer]": {server_err: "#sverr_referrer", maxlength: 1024},
			"regulation_referrer[remarks]": {server_err: "#sverr_remarks", maxlength: 255},
