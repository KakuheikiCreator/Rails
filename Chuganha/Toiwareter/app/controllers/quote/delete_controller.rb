...
require 'biz_actions/quote_delete/form_action'
require 'biz_actions/quote_delete/check_action'
require 'biz_actions/quote_delete/delete_action'

class Quote::DeleteController < ApplicationController
  include Filter::MethodRegulation
  include Filter::MemberRegulation
  include Filter::UpdateSession
  include BizActions::QuoteDelete
  # レイアウト定義
  layout nil
  # フィルタ設定
